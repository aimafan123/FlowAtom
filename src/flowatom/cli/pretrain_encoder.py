...
def main(argv=None) -> int:
    ...
    if dataset.input_length != int(section(load_config(args.config), "encoder")["input_length"]):
        raise ValueError("pretraining manifest input_length does not match encoder configuration")
